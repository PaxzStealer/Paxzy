-- Important Variables
local SCRIPT_NAME = "Paxz - Autofarm"
...
if game.PlaceId == 6284583030 or game.PlaceId == 10321372166 or game.PlaceId == 7722306047 or game.PlaceId == 12610002282 then
	...
	local Window = Rayfield:CreateWindow({
	   Name = "Paxz Auto Farm | By Paxz",
	   LoadingTitle = SCRIPT_NAME .. " " .. SCRIPT_VERSION,
	   LoadingSubtitle = "By LuaKiller",
	   ConfigurationSaving = {
		  Enabled = true,
		  FolderName = "Paxz",
	...
	local stats = autoFarmTab:CreateParagraph({Title = "Hello, <b><font color=\"#2B699F\">" .. LocalPlayer.DisplayName .. "</font></b>!", Content = "Thanks for using my script! - Paxz\nMake sure to join us at <b><font color=\"#2B699F\">https://discord.gg/jw6xSeNfBs</font></b>"})
